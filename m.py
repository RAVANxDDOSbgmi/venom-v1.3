...
bot = telebot.TeleBot('7354675191:AAH6DcHy2kCO0NHBa48JDNsMddZZMgDW3sI')
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @Ravan_Ddos 🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @Ravan_Ddos 🙇."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @Ravan_Ddos")
...
Buy From :- @Ravan_Ddos
Official Channel :- https://t.me/+wXqCalEX7l83MGE1
'''
...
3. MAKE SURE YOU JOINED https://t.me/+wXqCalEX7l83MGE1 OTHERWISE NOT WORK
